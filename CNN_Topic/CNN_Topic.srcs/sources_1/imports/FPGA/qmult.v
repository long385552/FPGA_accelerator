...
//    end
    ...
    assign c_result[N-1] = a[N-1]^b[N-1];                     //Sign bit of output would be XOR or input sign bits
    ...
    assign c_result[N-2:0] = (a[N-1]^b[N-1]) ? quantized_result_2cmp : quantized_result; //If the result is negative, we return a 2's complement representation 
    assign q_result = ((a == 0) || (b == 0) || (f_result[22:0] < 23'b000_0000_0000_0001_0000_0000)) ? 0 : c_result;
